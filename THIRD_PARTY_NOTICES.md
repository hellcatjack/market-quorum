...
Python and JavaScript dependencies retain the licenses declared by their
upstream packages. Dependency manifests and lock files identify the versions
used by this project. This notice does not replace any dependency's own license
